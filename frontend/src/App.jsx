      ...
      <main className="bw-page">
        ...
        <div className="bw-step-row">
          ...
          <div className={`bw-step-label ${preDone ? "bw-step-label-active" : "bw-step-label-locked"}`}>
            ...
            {preDone && <span style={{ fontSize: 15, color: "#7e838d", fontWeight: 400, marginLeft: 8 }}>Complete in order to unlock the next</span>}
          </div>
        </div>
            ...
            {(preDone || postDone) && (
              <div className="bw-assess-row">
                ...
                <div className="bw-assess-cell" style={{ opacity: postDone ? 1 : .5 }}>
                  ...
                  <div className="bw-assess-val" style={{ color: "#06a342" }}>{postScore !== null ? `${postScore}/10` : "—"}</div>
                  ...
                  return (
                    <div key={mode.id} className="bw-mode-prog-row">
                      ...
                      <div className="bw-mp-meta">
                        ...
                        {prog.complete && (
                          <span className="bw-mp-badge" style={{ background: "#f0fdf4", color: "#14532d", borderColor: "#06a342" }}>
                            ✓ Complete
                          </span>
                        )}
